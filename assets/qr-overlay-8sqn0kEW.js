const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/browser-wfejltAM.js","assets/index-MmD_uyqy.js","assets/index-Q7zLqut_.css"])))=>i.map(i=>d[i]);
import{_ as C}from"./index-MmD_uyqy.js";function T(l,o={}){const{qrSize:s=280,showCloseButton:y=!0,closeButtonText:p="×",theme:n="light",container:m=document.body,onCancel:x}=o,t=document.createElement("div");t.style.cssText=`
    position: fixed;
    inset: 0;

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/browser-CDk3n0Nr.js","assets/index-Atmi8JGg.js","assets/index-Q7zLqut_.css"])))=>i.map(i=>d[i]);
import{_ as C}from"./index-Atmi8JGg.js";function T(l,o={}){const{qrSize:s=280,showCloseButton:y=!0,closeButtonText:p="×",theme:n="light",container:m=document.body,onCancel:x}=o,t=document.createElement("div");t.style.cssText=`
    position: fixed;
    inset: 0;

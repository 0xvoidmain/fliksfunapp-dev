const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/browser-Cp3G1Y-B.js","assets/index-DmAg-nig.js","assets/index-DjCNNKzy.css"])))=>i.map(i=>d[i]);
import{_ as C}from"./index-DmAg-nig.js";function T(l,o={}){const{qrSize:s=280,showCloseButton:y=!0,closeButtonText:p="×",theme:n="light",container:m=document.body,onCancel:x}=o,t=document.createElement("div");t.style.cssText=`
    position: fixed;
    inset: 0;

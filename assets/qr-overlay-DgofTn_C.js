const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/browser-Dwa0u-_7.js","assets/index-M8s9W3dk.js","assets/index-wsng8Eed.css"])))=>i.map(i=>d[i]);
import{_ as C}from"./index-M8s9W3dk.js";function T(l,o={}){const{qrSize:s=280,showCloseButton:y=!0,closeButtonText:p="×",theme:n="light",container:m=document.body,onCancel:x}=o,t=document.createElement("div");t.style.cssText=`
    position: fixed;
    inset: 0;

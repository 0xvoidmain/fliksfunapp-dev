const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/browser-DzbJmY-0.js","assets/index-DlK-volk.js","assets/index-d5w3zJLa.css"])))=>i.map(i=>d[i]);
import{_ as C}from"./index-DlK-volk.js";function T(l,o={}){const{qrSize:s=280,showCloseButton:y=!0,closeButtonText:p="×",theme:n="light",container:m=document.body,onCancel:x}=o,t=document.createElement("div");t.style.cssText=`
    position: fixed;
    inset: 0;
